            ...
            <div className={styles.about__block}>
                ...
                <div className='container'>
                    <div className={styles.bright_lights}>
                        <div className={`${styles.about__left} ${'animate__animated'} ${isVisible ? 'animate__fadeInUp' : ''}`}>
                            ...
                            <div className={`${styles.about__text} `}>
                                <p>Bright Lights is a multi-Grammy nominated singer, songwriter, DJ and record producer.
                                    ...
                                    has
                                    amassed over 1 billion streams worldwide. More than 100 million of those streams can
                                    be
                                    attributed to her artist career and include such hits as Porter Robinson's
                                    "Language,"
                                    3LAU's "How You Love Me" and her own single "Runaway." She was also a featured
                                    vocalist
                                    on
                    ...
                    <div className={`${styles.bio} ${'animate__animated'} ${isVisible ? 'animate__fadeInUp' : ''}`}>
